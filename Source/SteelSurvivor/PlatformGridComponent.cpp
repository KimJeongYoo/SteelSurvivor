...
void UPlatformGridComponent::BeginPlay()
{
    ...
    */
    ...
    {
        UE_LOG(LogTemp, Warning, TEXT("PlatformGrid Tick Successfully Enabled in BeginPlay!"));
    }
...
// PlatformGridComponent.cpp 파일 맨 아래에 추가
...
void UPlatformGridComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
	...
	UE_LOG(LogTemp, Warning, TEXT("PlatformGrid Ticking	"));
